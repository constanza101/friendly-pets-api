...
//ipdate to found: status=found, found_date, found_address_id, owner_user_id, animal_breed_id
...
app.post("/animal", function(req, res){
  ...
  var creation_date = req.body.creation_date; //se agrega sola al registrar el animal
  var status = req.body.status;
  //update to lost
  var lost_date = req.body.lost_date;
  var lost_address_id = req.body.lost_address_id;
  //update to found
  var found_date = req.body.found_date;
